...
contextBridge.exposeInMainWorld('nexusAPI', {
  ...
  readingMode: {
    ...
    activate: () => ipcRenderer.invoke('reading-mode-activate'),
    deactivate: () => ipcRenderer.invoke('reading-mode-deactivate'),
  },
  ...
  extensions: {
    ...
    uninstallExtension: (id) => ipcRenderer.invoke('remove-extension', id),
